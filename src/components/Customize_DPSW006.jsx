            ...
            customizationData.map((productDetail, index) => (
              <TableRow key={index}>
                <TableCell colSpan={4}>
                  ...
                  <TextField
                    id={`custom-line1-input-${productDetail[1]}-${index}`}
                    value={productDetail[3] || ""}
                    label="Customization Line1 (Case sensitive)"
                  ...
                  />
                  <TextField
                    id={`custom-line2-input-${productDetail[1]}-${index}`}
                    value={productDetail[4] || ""}
                    label="Customization Line2 (Case sensitive)"
                    helperText="E.g. MBBS"
                    onChange={(e) => {
                      const newCustomizationData = [...customizationData];
...
export default Customize_DPSW006;
